...
require('./modules/app.core.module');
require('./modules/app.main.module');
require('./controllers/main.controller');
require('./controllers/second.controller');

},{"./controllers/main.controller":2,"./controllers/second.controller":3,"./modules/app.core.module":4,"./modules/app.main.module":5,"./modules/app.module":6}],2:[function(require,module,exports){
(function () {
    'use strict';
